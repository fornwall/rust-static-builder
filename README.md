[![Build status](https://github.com/fornwall/rust-static-builder/workflows/Docker%20Image%20CI/badge.svg)](https://github.com/fornwall/rust-static-builder/actions?query=branch%3Amaster)
